...
export default function BottomToolbar() {
  return (
    <div className="fixed bottom-6 left-1/2 transform -translate-x-1/2 bg-white rounded-full shadow-lg border border-gray-200 px-2 py-2 flex items-center gap-2">
      <button className="flex items-center gap-2 px-4 py-2 rounded-full hover:bg-gray-200 transition-colors text-gray-700">
        <Workflow size={18} />
      ...
      <div className="w-px h-6 bg-gray-200"></div>
      <button className="flex items-center gap-2 px-4 py-2 rounded-full hover:bg-gray-200 transition-colors text-blue-700">
        <Sparkles size={18} />
